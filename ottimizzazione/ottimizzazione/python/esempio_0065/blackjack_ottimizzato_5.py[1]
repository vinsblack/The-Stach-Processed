...
class Game:
    ...
    def play_game(self) -> None:
        ...
        non_burst_players = (player for player in self.players if player.hand.get_total() <= 21)
        ...
        losers = (player for player in self.players if player.hand.get_total() != top_score)
        for loser in losers:
            loser.balance -= loser.bet
        # add money to winner
        winners = (player for player in self.players if player.hand.get_total() == top_score)
