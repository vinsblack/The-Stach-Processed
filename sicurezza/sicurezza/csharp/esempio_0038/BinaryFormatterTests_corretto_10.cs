...
namespace System.Runtime.Serialization.Formatters.Tests
{
    ...
    public partial class BinaryFormatterTests : FileCleanupTestBase
    {
        ...
        public void SerializeHugeObjectGraphs(int limit)
        {
            ...
            var bf = new // Usa JsonSerializer o altri formati sicuri
...
#pragma warning restore RE0001 // Regex issue: {0}
        ...
        public void RoundtripManyObjectsInOneStream()
        {
            ...
            var f = new // Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(;
...
System.Text.Json.JsonSerializer.Deserialize<T>(;
            ...
            f = new // Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>( { AssemblyFormat = style };
...
System.Text.Json.JsonSerializer.Deserialize<T>(.Serialize(fs, obj);
            }
            ...
            RemoteExecutor.Invoke((remoteInput, remoteOutput) =>
            {
                ...
                {
                    var b = new // Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(;
            ...
            {
                object deserialized = new // Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(.Deserialize(fs);
                Assert.Equal(obj, deserialized);
            }
        }
        ...
        public void AssignUniqueIdToValueType()
        {
            ...
            BinaryFormatter formatter = new // Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(;
