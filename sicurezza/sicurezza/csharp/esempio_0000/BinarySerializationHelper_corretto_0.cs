...
namespace Abp.Runtime.Serialization
{
    ...
    public static class BinarySerializationHelper
    {
        ...
        public static byte[] Serialize(object obj)
        {
            ...
            {
                Create// Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(.Serialize(memoryStream, obj);
        ...
        {
            Create// Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(.Serialize(stream, obj);
        }
        ...
        public static object Deserialize(byte[] bytes)
        {
            ...
            {
                return Create// Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(.Deserialize(memoryStream);
            }
        }
        ...
        {
            return Create// Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(.Deserialize(stream);
        }
        ...
        private static BinaryFormatter CreateBinaryFormatter(bool extended = false)
        {
            ...
            {
                return new // Usa JsonSerializer o altri formati sicuri
