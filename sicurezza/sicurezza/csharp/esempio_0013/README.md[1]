# Esempio di Sicurezza 0013

## Vulnerabilità 1: Deserializzazione Insicura

File vulnerabile: `InvalidAsynchronousStateExceptionTests_vulnerabile_0.cs`

File corretto: `InvalidAsynchronousStateExceptionTests_corretto_0.cs`
