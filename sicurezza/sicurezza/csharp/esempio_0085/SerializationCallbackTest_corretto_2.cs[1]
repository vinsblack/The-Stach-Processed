...
namespace MonoTests.System.Runtime.Serialization
{
        ...
        public class SerializationCallbackTest
        {
                ...
                {
                        Log.Clear ();
                        Driver (new // Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(, new A (new B()));
                ...
                public void TestInheritance ()
                {
                        Log.Clear ();
                        Driver (new // Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(, new C (new B()));
                        //Console.WriteLine (Log.Text);
                ...
                public void TestISerializable ()
                {
                        Log.Clear ();
                        Driver (new // Usa JsonSerializer o altri formati sicuri
System.Text.Json.JsonSerializer.Deserialize<T>(, new A (new D()));
                        //Console.WriteLine (Log.Text);
                        Assert.AreEqual (Log.Text, "A1B1A2B2A3B3B4A4");
                }
